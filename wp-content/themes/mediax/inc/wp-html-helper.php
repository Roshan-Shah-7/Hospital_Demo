...
// image default alt
if( !function_exists( 'mediax_img_default_alt' ) ){
	function mediax_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'mediax_img_tag' ) ){
	function mediax_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = mediax_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'mediax_anchor_tag' ) ){
	function mediax_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'mediax_heading_tag' ) ){
	function mediax_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'mediax_paragraph_tag' ) ){
	function mediax_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'mediax_span_tag' ) ){
	function mediax_span_tag( array $args ){
