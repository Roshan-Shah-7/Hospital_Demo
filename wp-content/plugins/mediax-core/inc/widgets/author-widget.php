...
class mediax_author_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'mediax_author_widget',

                // Widget name will appear in UI
                esc_html__( 'Mediax :: Author Widget', 'mediax' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'mediax' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'mediax'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'mediax'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'mediax'); ?></label>
    ...
    } // Class mediax_author_widget ends here


    // Register and load the widget
    function mediax_author_load_widget() {
        register_widget( 'mediax_author_widget' );
    }
    add_action( 'widgets_init', 'mediax_author_load_widget' );