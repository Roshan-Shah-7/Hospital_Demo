...
class mediax_recent_posts_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'mediax_recent_posts_widget',

                // Widget name will appear in UI

                esc_html__( 'Mediax :: Recent Posts', 'mediax' ),
                ...
                array(
                    ...
                    'description'                   => esc_html__( 'Add Recent Posts Widget', 'mediax' ),
                )
            );
        }
                                    ...
                                    echo '<div class="media-img">';
                                        echo '<a href="'.get_the_permalink().'">';
                                            echo mediax_img_tag( array(
                                                "url"   => esc_url( get_the_post_thumbnail_url( null, 'mediax_85X85' ) ),
                                            ) );
                                        echo '</a>';
                                    echo '</div>';
                                }
        ...
        public function form( $instance ) {
           ...
           //Post title Count
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ,'mediax'); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Number of Posts to show:' ,'mediax'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_title_count' ); ?>"><?php _e( 'Number of title word to show:' ,'mediax'); ?></label>
    ...
    } // Class mediax_recent_posts_widget ends here


    // Register and load the widget
    function mediax_recent_posts_load_widget() {
        register_widget( 'mediax_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'mediax_recent_posts_load_widget' );