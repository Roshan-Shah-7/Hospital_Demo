...
function mediax_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'mediax' ),
        'next_string'     => esc_html__( '&raquo;', 'mediax' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'mediax_pagination_defaults', $defaults )
    );
